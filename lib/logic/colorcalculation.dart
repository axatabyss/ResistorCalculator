...
class ColorCalculation {
  ColorCalculation(this.resistance, this.tolerance);
  ...
  Map getColors(List<int> digits) {
    ...
    decade = temp.floor();
    Map combination = {
      'D1':Paint() ..color = digitColors[newDigits[0]] ..style = PaintingStyle.fill,
      'D2':Paint() ..color = digitColors[newDigits[1]] ..style = PaintingStyle.fill,
      'D3':Paint() ..color = digitColors[newDigits[2]] ..style = PaintingStyle.fill,
      'Multiplier':Paint() ..color = digitColors[decade] ..style = PaintingStyle.fill,
      'Tolerance':Paint() ..color = toleranceColors[tolerance] ..style = PaintingStyle.fill,
    };
    return combination;
  }
